...
const PLAY = "https://play.google.com/store/apps/details?id=com.hermit85.cmok";
      ...
      <section className="hero-section" style={{ display:'flex',alignItems:'center',justifyContent:'center',padding:'100px 24px 60px',position:'relative',overflow:'clip',minHeight:'85vh' }}>
        ...
        <div style={{ position:'relative',zIndex:10,display:'flex',alignItems:'center',gap:48,maxWidth:920,width:'100%',flexWrap:'wrap',justifyContent:'center' }}>
          <div style={{ flex:'1 1 320px',maxWidth:420,textAlign:'center' }}>
            ...
            {/* CTA */}
            <div className="hero-enter hero-enter-d4" style={{ display:'flex',flexDirection:'column',gap:12,alignItems:'center' }}>
              <div style={{ display:'flex',gap:10,flexWrap:'wrap',justifyContent:'center' }}>
                ...
                <a href={PLAY} className="cta-button">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.199l2.807 1.626a1 1 0 0 1 0 1.732l-2.808 1.626L15.198 12l2.5-2.492zM5.864 2.658L16.8 8.99l-2.302 2.302-8.635-8.635z"/></svg>
                  Pobierz na Androida
                </a>
              </div>
